...
abstract class SemiAutomaticFirearm(reloadTicks: Int, cartridgeName: String, cartridgeClass: Class[_ <: Entity], magazineCapacity: Int) extends Firearm(reloadTicks, cartridgeName, cartridgeClass, magazineCapacity) {
